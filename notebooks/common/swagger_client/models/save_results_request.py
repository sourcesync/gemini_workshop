...
class SaveResultsRequest(object):
    ...
    def __init__(self, distance=None, indices=None, directory_to_save_results=None):  # noqa: E501
    ...
    def directory_to_save_results(self, directory_to_save_results):
        ...
        :type: str
        """
        if directory_to_save_results is None:
            raise ValueError("Invalid value for `directory_to_save_results`, must not be `None`")  # noqa: E501
